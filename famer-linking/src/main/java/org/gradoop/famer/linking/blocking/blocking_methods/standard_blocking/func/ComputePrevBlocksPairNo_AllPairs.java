...
/**
 */
public class ComputePrevBlocksPairNo_AllPairs implements GroupReduceFunction<Tuple3<String, Long, Long>, Tuple5<String, Long, Long, Long, Long>>{
    @Override
    public void reduce(Iterable<Tuple3<String, Long, Long>> in, Collector<Tuple5<String, Long, Long, Long, Long>> out) throws Exception {
