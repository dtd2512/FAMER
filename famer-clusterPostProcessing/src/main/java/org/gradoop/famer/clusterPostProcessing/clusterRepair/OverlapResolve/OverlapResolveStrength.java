...
import org.gradoop.famer.clusterPostProcessing.clusterRepair.OverlapResolve.functions.OVFunc.*;
import org.gradoop.famer.clusterPostProcessing.clusterRepair.OverlapResolve.functions.cluster2vertex_vertexId;
...
/**
 */
public class OverlapResolveStrength implements UnaryGraphToGraphOperator {
    private Double delta;
    public OverlapResolveStrength (Double inputDelta){delta = inputDelta;}
    @Override
...
/*Phase 1:*/
        ...
        DataSet<Vertex> toBeResolvedVertices = vertices.flatMap(new filterOverlappedVertices(1));
        ...
        DataSet<Tuple3<Vertex, String, String>> vertex_oldClsId_newClsId = toBeResolvedVertexId_vertex_cluster.groupBy(0)
                .reduceGroup(new MergeResolver(ResolveIteration.ITERATION1));
        ...
        clusters = clusters.map(new cluster2cluster_clusterId()).groupBy(1).reduceGroup(new consolidateClusters());
...
/*Phase 2:*/
        ...
        toBeResolvedVertices = vertices.flatMap(new filterOverlappedVertices(2));
        ...
        // process overlapped vertices
        vertex_oldClsId_newClsId = toBeResolvedVertexId_vertex_cluster.groupBy(0).reduceGroup(new MergeResolver(ResolveIteration.ITERATION2));
    ...
    public String getName() {
        return OverlapResolveStrengthNoMrg.class.getName();
    }
