...
/**
 */
public class detectNeighborIds implements FlatMapFunction <Tuple2<String, String>, Tuple1<String>>{
    private String clusterId;
    public detectNeighborIds (String ClusterId){ clusterId = ClusterId;}
    @Override
    public void flatMap(Tuple2<String, String> value, Collector< Tuple1<String>> out) throws Exception {
        Set<String> clusterIds0 = new HashSet<String>();
        Collections.addAll(clusterIds0, value.f0.split(","));
        Set<String> clusterIds1 = new HashSet<String>();
