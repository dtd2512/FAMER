...
public class Star
    ...
    public Star(int prioIn, int typeIn, boolean IsEdgesFullIn, clustering.ClusteringOutputType ClusteringOutputType) {
        prio = prioIn;
        type = typeIn;
...
//        LogicalGraph resultLG = LogicalGraph.fromDataSets(result.getVertices().map(new ToGradoopVertex()), result.getEdges(),input.getConfig());
