...
import org.gradoop.famer.clustering.parallelClusteringGraph2Graph.util.CenterMessage;
...
public class MergeCenter
    ...
    public MergeCenter(int prioIn, double thresholdIn, boolean IsEdgesFullIn, clustering.ClusteringOutputType ClusteringOutputType) {
        prio = prioIn;
...
//        LogicalGraph resultLG = LogicalGraph.fromDataSets(result.getVertices().map(new Center.ToGradoopVertex()), input.getEdges(),input.getConfig());
